...
class UI:
    ...
    def scrolled_text(self):
        text_area = scrolledtext.ScrolledText(self.main_canvas, wrap = WORD, font=("Arial", 10))
        text_area.grid(column = 0, pady = 10, padx = 10)
        text_area.focus()
        text_area.config(state=DISABLED)
        text_area(INSERT, "aaa")

        text_area_window = self.main_canvas.create_window(self.sidebar_position[1]+59, self.topbar_position[3]+1, width=720, height=int(self.bottombar_position[3]-25), anchor=NW, window=text_area)
